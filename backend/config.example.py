...
NAUKRI_PROXY_REFRESH_MINUTES = 10        # background pool refresher cadence
NAUKRI_PROXY_TEST_TIMEOUT = 12           # seconds per proxy probe (hard cap +3)
NAUKRI_PROXY_TEST_LIMIT = 30             # proxies probed per refresh
NAUKRI_PROXY_TEST_MIN_TARGET = 10        # stop refresh pass once this many working found
...
NAUKRI_PROXY_POOL_MAX = 100               # max rows kept per board
